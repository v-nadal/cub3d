...
/*   Updated: 2023/02/06 16:50:12 by argomez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	datas->textures.n_wall.img = NULL;
	datas->textures.s_wall.img = NULL;
	datas->textures.w_wall.img = NULL;
	datas->textures.e_wall.img = NULL;
	datas->textures.ceiling = NULL;
	datas->textures.floor = NULL;
	datas->textures.north = NULL;
	datas->textures.south = NULL;
	datas->textures.west = NULL;
	datas->textures.east = NULL;
}
